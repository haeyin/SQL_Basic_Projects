...
INSERT INTO tbl_persons	
	...
	('clare', 'shin', '232-345-5768'),
	('aiko', 'amano', '232-345-5768'),
	('lauren', 'kayahara', '232-345-5768'),
	('mervyn', 'chua', '232-345-5768')
;

SELECT persons_fname, persons_lname, persons_contact FROM tbl_persons WHERE persons_lname LIKE '_h%a';

UPDATE tbl_persons SET persons_fname = 'collette' WHERE persons_fname = 'clare';

SELECT persons_fname, persons_lname, persons_contact FROM tbl_persons WHERE persons_lname LIKE 's%' ORDER BY persons_lname DESC;

SELECT persons_fname AS 'First Name', persons_lname AS 'Last Name', persons_contact AS 'Phone' FROM tbl_persons WHERE persons_lname LIKE 's%';
...
INSERT INTO tbl_specialist
	...
	('kem', 'byessan', '384-485-4855'),
	('delmonte', 'fydo', '768-288-3749')
;
